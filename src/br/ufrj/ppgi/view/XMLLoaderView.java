...
public class XMLLoaderView extends JFrame{
    ...
    public XMLLoaderView(Component component, String extension, String action) {
        super();
    ...
    private void initComponents() {
        ...
        processButton.setAction(actionMap.get(action)); 
    ...
    MouseListener mouseListener = new MouseAdapter() {
        public void mouseClicked(MouseEvent e) {
            if (e.getClickCount() == 2) {
            	String itemLista = (String)lista.getSelectedValue();
